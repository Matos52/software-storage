  ...
  return (
    <div className="relative">
      <img
        src={image}
        alt={title}
        className="w-full h-auto md:h-[470px] object-cover mb-14 rounded-2xl"
      />

      <div className="absolute left-0 right-0 bottom-0 flex justify-center">
        <div className="bg-white w-4/5 rounded-lg px-4 py-3 shadow-md hover:shadow-lg">
          <Link to={`/accommodation/${slug}`} className="group">
            <h2 className="relative inline-block text-base md:text-xl font-semibold text-gray-800 transition-colors duration-300 group-hover:text-gray-700">
              {title}
